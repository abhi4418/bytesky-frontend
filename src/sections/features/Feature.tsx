        ...
        <div className="flex flex-col gap-2 col-span-1">
          ...
          <FeatureCard className="col-span-1">
            ...
            <div className="text-neutral-40 text pt-4">
              ...
              monitoring, model fine-tuning capabilities, and scalable API
              endpoint deployment.
            </div>
          </FeatureCard>
        </div>
        ...
        <div className="flex flex-col gap-2 col-span-1">
          <FeatureCard>
            ...
            <div className="text-neutral-40 text pt-4">
              ...
              setup, and 5 Gbps bandwidth, it’s perfect for schools upgrading
              for CBSE, businesses avoiding pricey upgrades, and gaming cafes
              needing a performance kick.
            </div>
          </FeatureCard>
          <FeatureCard>
            <Logo4 />
            ...
            <div className="text-neutral-40 text pt-4">
              ...
              e-waste and offer environmentally friendly alternatives.
            </div>
            <motion.div
              initial="hidden"
              whileInView="visible"
      ...
      <div className="max-w-screen-lg mx-auto pt-20 ">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-4">
          <motion.div
            ...
            className="col-span-1 md:px-6 px-2"
          >
            ...
            <div className="text-neutral-60 text-base leading-tight pt-4 text-center md:text-left md:px-0 px-6">
              ...
              high-performance computing solutions for researchers, startups,
              and enterprises.
            </div>
            ...
            <div className="grid grid-cols-2 pt-8 px-auto mx-auto w-full gap-y-8">
              ...
              <PricewithLabel
                className="col-span-1"
                price="$15M+"
                label="Gen AI Enabled Startup"
              />
              <PricewithLabel
                className="col-span-1"
                price="$5M+"
                label="Signed LOI with schools"
              />
              <PricewithLabel
                className="col-span-1"
                price="$2M+"
