    ...
    return (
        <div id="features">
            ...
            <div className="max-w-screen-md mx-auto flex flex-col items-center justify-center pt-8">
                <div className="text-gray-300 text-4xl font-semibold text-center">
            ...
            <div className="pt-20 mx-4 md:max-w-screen-lg md:mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-2 col-span-1">
                    <FeatureCard>
                        <Logo1 />
                        <div className="text-gray-300 text-xl font-semibold pt-4">
                            Tailored Cloud Configurations
                        </div>
                        <div className="text-gray-200 text pt-4">
            ...
            <div className="max-w-screen-lg mx-auto pt-20">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-4">
                    ...
                    className="col-span-1">
                        ...
                        <div className="text-center md:text-left text-gray-300 text-2xl font-semibold pt-4">
                            Hey there! We're ByteSky, revolutionizing cloud
                            computing.
                        </div>
                        <div className="text-gray-200 text-xl leading-tight pt-4 text-center md:text-left">
